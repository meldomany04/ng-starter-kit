...
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, SelectButtonModule, FormsModule],
...
export class AppTopbar {
    ...
    constructor(public layoutService: LayoutService) {
        this.selectedLanguage = this.layoutService.layoutConfig().language || 'en';
    }
    ...
    onLanguageChange(lang: string) {
        this.layoutService.setLanguage();
    }
}